package com.mxlib
{
	...
	public class ScriptContentLoader extends EventDispatcher
	{
		...
		private var _content:ScriptContent;
		public function get content() : ScriptContent { return this._content; }
		...
		public function load(file:String, content:ScriptContent = null, listener:Function = null) : Boolean
		{
